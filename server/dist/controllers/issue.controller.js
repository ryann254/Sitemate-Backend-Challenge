...
exports.deleteIssueController = exports.updateIssueController = exports.getIssueController = exports.createIssueController = void 0;
var createIssueController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (!req.body)
            throw new Error('Request body is required');
        console.log(req.body);
        return [2 /*return*/, res.status(201).json(req.body)];
    });
}); };
...
var updateIssueController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (!req.body)
            throw new Error('Request body is required');
        if (!req.params.id)
...
var deleteIssueController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (!req.params.id)
            throw new Error('Id is required');
